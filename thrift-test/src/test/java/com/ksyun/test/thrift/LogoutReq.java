...
public class LogoutReq implements org.apache.thrift.TBase<LogoutReq, LogoutReq._Fields>, java.io.Serializable, Cloneable, Comparable<LogoutReq> {
    ...
    public LogoutReq(java.lang.String token) {
        this();
        this.token = token;
    }
    ...
    public LogoutReq setToken(@org.apache.thrift.annotation.Nullable java.lang.String token) {
        this.token = token;
        return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof LogoutReq) return this.equals((LogoutReq) that);
        return false;
    }
    ...
    public int hashCode() {
        ...
        if (isSetToken()) hashCode = hashCode * 8191 + token.hashCode();
