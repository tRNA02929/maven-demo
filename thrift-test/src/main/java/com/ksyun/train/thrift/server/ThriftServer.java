//package com.ksyun.train.thrift.server;
//
//import com.ksc.thrift.Service;
//import com.ksc.thrift.service.ServiceImpl;
...
//            Service.Processor<ServiceImpl> processor = new Service.Processor<>(new ServiceImpl());
